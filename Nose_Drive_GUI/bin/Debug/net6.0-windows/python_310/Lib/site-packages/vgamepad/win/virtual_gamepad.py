...
class VX360Gamepad(VGamepad):
    ...
    ##### ASPHI ######
    def left_joystick_x(self, x_value):
        self.report.sThumbLX = x_value
    
    def left_joystick_y(self, y_value):
        self.report.sThumbLY = y_value

    def right_joystick_x(self, x_value):
        self.report.sThumbRX = x_value

    def right_joystick_y(self, y_value):
        self.report.sThumbRY = y_value

    def left_joystick_float_x(self, x_value_float):
        self.left_joystick_x(round(x_value_float * 32767))
    
    def left_joystick_float_y(self, y_value_float):
        self.left_joystick_y(round(y_value_float * 32767))

    def right_joystick_float_x(self, x_value_float):
        self.right_joystick_x(round(x_value_float * 32767))

    def right_joystick_float_y(self, y_value_float):
        self.right_joystick_y(round(y_value_float * 32767))
