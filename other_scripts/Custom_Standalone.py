...
# Sensibility values
nose_horizontal_sensibility = 15
nose_vertical_sensibility = 30
mouth_horizontal_sensibility = 50
mouth_vertical_sensibility = 0
head_tilt_sensibility = 40
eyebrows_sensibility = 100
mouth_open_sensibility = 100
calibration_time = 3
